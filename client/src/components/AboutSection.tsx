  ...
  return (
    <section id="about" className="mb-12">
      <div className="ultraball-card p-3 sm:p-4 md:p-6">
        <h3 className="text-lg sm:text-xl md:text-2xl font-bold mb-2 sm:mb-3 md:mb-4 text-ultraball-black">About PokéRank</h3>
        ...
        <div className="prose max-w-none text-xs sm:text-sm md:text-base">
          ...
          <h4 className="text-base sm:text-lg md:text-xl font-semibold mt-3 sm:mt-4 md:mt-6 mb-1 sm:mb-2 md:mb-3 text-ultraball-black">How it Works</h4>
          ...
          <p className="mb-2 sm:mb-3 md:mb-4">
            ...
            <a 
              ...
              className="text-ultraball-gold hover:underline ml-1"
              target="_blank"
          ...
          <div className="bg-ultraball-black/10 border border-ultraball-gold/40 rounded-lg p-2 sm:p-3 md:p-4 mt-3 sm:mt-4 md:mt-6">
            <h5 className="font-semibold mb-1 sm:mb-2 text-xs sm:text-sm md:text-base text-ultraball-black">Data Sources:</h5>
            <p className="text-[10px] sm:text-xs md:text-sm text-ultraball-black/80">
