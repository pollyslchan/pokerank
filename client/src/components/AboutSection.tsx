  ...
  return (
    <section id="about" className="mb-12">
      <div className="bg-white rounded-xl shadow-lg p-4 sm:p-6">
        <h3 className="text-xl sm:text-2xl font-bold mb-3 sm:mb-4">About PokéRank</h3>
        ...
        <div className="prose max-w-none text-sm sm:text-base">
          ...
          <h4 className="text-lg sm:text-xl font-semibold mt-4 sm:mt-6 mb-2 sm:mb-3">How it Works</h4>
          <ol className="list-decimal pl-4 sm:pl-6 space-y-1 sm:space-y-2 mb-3 sm:mb-4">
          ...
          <div className="bg-light-gray rounded-lg p-3 sm:p-4 mt-4 sm:mt-6">
            <h5 className="font-semibold mb-1 sm:mb-2 text-sm sm:text-base">Data Sources:</h5>
